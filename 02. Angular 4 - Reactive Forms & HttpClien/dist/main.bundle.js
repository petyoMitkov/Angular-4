...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_data_service__ = __webpack_require__(51);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_data_service__ = __webpack_require__(51);
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._dataServise.getData().subscribe(function (res) {
            //this.contacts = res;
            for (var key in res) {
                console.log(key, res[key].person);
                _this.contacts.push({ person: res[key].person, phone: res[key].phone });
            }
