...
module.exports = "<footer class=\"row\">\n    <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">\n        @2018 Powered by\n        <a href=\"https://www.linkedin.com/in/petyo-mitkov-1b30ab28/\" target=\"blanck\">Petyo Mitkov</a>\n    </div>\n</footer>"
...
var DataService = (function () {
    ...
    DataService.prototype.updateContact = function (contact, id) {
        var url = "https://phonebook-f6ac7.firebaseio.com/phonebook/" + id + ".json";
        return this._http.put(url, contact, httpOptions);
    };
    return DataService;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_data_service__ = __webpack_require__(24);
...
var EditFormComponent = (function () {
    function EditFormComponent(_dataService, _formBilder) {
        this._dataService = _dataService;
        this._formBilder = _formBilder;
        this.updatedContact = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["h" /* EventEmitter */]();
        this.editCancel = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["h" /* EventEmitter */]();
    ...
    EditFormComponent.prototype.editRecord = function (contact, id) {
        console.log(contact);
        console.log(id);
        ...
        this._dataService.updateContact(contact, id).subscribe(function (res) {
            console.log(res);
        });
    ...
    // Edit Validation ===================================
    EditFormComponent.prototype.createFormValidationEdit = function () {
        this.editForm = this._formBilder.group({
            "person": ["" + this.editValue.person, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].compose([
            ...
            "city": ["" + this.editValue.city, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].required],
            "occupation": ["" + this.editValue.occupation, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].required],
            "phone": ["" + this.editValue.phone, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].compose([
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].required,
    ...
    EditFormComponent.prototype.phoneValidatorStart = function (control) {
    ...
    EditFormComponent.prototype.phoneValidatorOnlyNumbers = function (control) {
        var phoneInput = control.value.trim();
        var regEx = /^(\+|00)+[0-9]+$/;
...
], EditFormComponent.prototype, "editValue", void 0);
__decorate([
...
], EditFormComponent.prototype, "updatedContact", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* Output */])(),
...
], EditFormComponent.prototype, "editCancel", void 0);
EditFormComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_data_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_data_service__["a" /* DataService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormBuilder */]) === "function" && _d || Object])
], EditFormComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_dashboard_dashboard_component__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_data_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_form_form_component__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_edit_form_edit_form_component__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_footer_footer_component__ = __webpack_require__(88);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__components_edit_form_edit_form_component__["a" /* EditFormComponent */],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_data_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_form_edit_form_component__ = __webpack_require__(52);
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.deleteRecord = function (contact) {
        ...
        this._dataService.deleteContact(contact).subscribe(function () {
    ...
    DashboardComponent.prototype.edit = function (contact) {
        ...
        if (this.viewEditForm === true) {
            setTimeout(function () {
                _this.child.createFormValidationEdit();
            }, 100);
        }
    };
    DashboardComponent.prototype.onUpdatedContact = function (contact) {
        for (var i in this.contactsList) {
            if (this.contactsList[i].id == contact.id) {
                this.contactsList[i] = contact;
            }
        }
    };
    DashboardComponent.prototype.onEeditCancel = function (cancel) {
        console.log("Tukaa");
        this.viewEditForm = false;
    };
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_6" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_2__edit_form_edit_form_component__["a" /* EditFormComponent */]),
    __metadata("design:type", Object)
